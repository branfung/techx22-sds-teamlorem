class Product:
    ...
    def __init__(self, name: str, price, creator: str, quantity: int, image_url: str):
    ...
    def from_document(cls, document):
        '''Constructs and returns a new product from a JSON document'''
        return Product(document['name'], document['price'], document['creator'], document['quantity'], document['image_url'])
    
    def to_document(self):
        '''Returns the product instance in document/JSON format'''
